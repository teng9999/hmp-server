...
@Component
@ThriftService
public class TAirModeServiceIface implements
		cn.pl.hmp.commons.thrift.service.TAirModeService.Iface {
	@Autowired
	...
	@Override
	public Map<TPages, List<TAirMode>> loadPages(TPages tPages)
