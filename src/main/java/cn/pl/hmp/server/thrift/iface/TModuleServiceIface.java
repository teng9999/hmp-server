...
public class TModuleServiceIface implements TModuleService.Iface {
    ...
    @Override
    public Map<TPages, List<TModule>> queryByPages(TPages pages)
            throws TException {
        Map<TPages,List<TModule>> tmap = new HashMap<TPages, List<TModule>>();
        TPages tempPage = null;
        Map<Pages,List<Module>> moduleMap = moduleBusiness.selectByPages(null,ObjectConverter.convet(pages, Pages.class));
