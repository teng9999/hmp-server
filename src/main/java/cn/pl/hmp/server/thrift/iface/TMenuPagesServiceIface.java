...
public class TMenuPagesServiceIface implements TMenuPagesService.Iface {
    ...
    @Override
    public Map<TPages, List<TMenuPages>> queryByPages(TPages pages)
            throws TException {
        Map<TPages,List<TMenuPages>> tmap = new HashMap<TPages, List<TMenuPages>>();
        TPages tempPage = null;
        Map<Pages,List<MenuPages>> menuPagesMap = menuPagesBusiness.selectByPages(null,ObjectConverter.convet(pages, Pages.class));
