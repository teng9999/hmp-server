...
@Component
@ThriftService
public class TAPPInfoServiceIface implements
		cn.pl.hmp.commons.thrift.service.TAPPInfoService.Iface {
	@Autowired
	...
	@Override
	public Map<TPages, List<TAPPInfo>> loadPages(TPages tPages)
