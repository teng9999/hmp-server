 ...
 */
@Service
public class APPBindingBusinessImpl extends AbstractBusiness implements IAPPBindingBusiness {
    @Autowired
    ...
    @Override
    public Map<Pages, List<APPBinding>> queryPages(APPBindingExample example, Pages pages) {
