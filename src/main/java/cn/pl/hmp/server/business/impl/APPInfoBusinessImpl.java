 ...
 */
@Service
public class APPInfoBusinessImpl extends AbstractBusiness implements IAPPInfoBusiness {
    @Autowired
    ...
    @Override
    public Map<Pages, List<APPInfo>> queryPages(APPInfoExample example, Pages pages) {
