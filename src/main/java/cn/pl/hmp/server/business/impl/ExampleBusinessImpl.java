 ...
 */
@Service
public class ExampleBusinessImpl extends AbstractBusiness implements
		IExampleBusiness {
	@Autowired
	 ...
	 * 
	 * @see
	 * cn.pl.hmp.server.business.iface.IExampleBusiness#queryPages(cn.pl.hmp
	 * .server.dao.entity.HmpTestExample, cn.pl.commons.pages.Pages)
	 */
	@Override
	public Map<Pages, List<HmpTest>> queryPages(HmpTestExample example,
			Pages pages) {
