 ...
 */
@Service
public class HotelRCUCfgBusinessImpl extends AbstractBusiness implements IHotelRCUCfgBusiness {
    @Autowired
    ...
    @Override
    public Map<Pages, List<HotelRCUCfg>> queryPages(HotelRCUCfgExample example, Pages pages) {
