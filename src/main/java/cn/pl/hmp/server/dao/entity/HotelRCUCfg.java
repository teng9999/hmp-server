...
public class HotelRCUCfg {
    ...
    public void setAnalogInputNum(String analogInputNum) {
        this.analogInputNum = analogInputNum == null ? null : analogInputNum.trim();
    }
    ...
    public void setAirConditionerNum(String airConditionerNum) {
        this.airConditionerNum = airConditionerNum == null ? null : airConditionerNum.trim();
    }
    ...
    public void setDigitalInputNum(String digitalInputNum) {
        this.digitalInputNum = digitalInputNum == null ? null : digitalInputNum.trim();
    }
    ...
    public void setDigitalOutputNum(String digitalOutputNum) {
        this.digitalOutputNum = digitalOutputNum == null ? null : digitalOutputNum.trim();
    }
